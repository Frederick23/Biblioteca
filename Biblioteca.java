...
public class Biblioteca
{
   public static void main ( String argv[]){
       ...
       disponibles.pon(new Libro(20,"El Buscon","Quevedo",Genero.NOVELA,1997));
       disponibles.pon(new Libro(21,"Romeo y Julieta","Shakespeare ",Genero.TEATRO,1997));
       disponibles.pon(new Libro(22,"Mio Cid","Anonimo",Genero.POESIA,1989));
   
       prestados.pon( new Libro(30,"Harry Potter I", "J. K. Rowling", Genero.NOVELA,1998));
       prestados.pon( new Libro(34,"Guerra y Paz","Leon Tolstoi",Genero.NOVELA,1975));
       prestados.pon( new Libro(19,"El Decameron","Giovanni Boccaccio",Genero.CUENTOS,1992));
